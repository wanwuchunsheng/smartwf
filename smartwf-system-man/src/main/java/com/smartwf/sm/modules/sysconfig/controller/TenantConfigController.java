...
public class TenantConfigController {
	...
	/**
	 * @Description: 查询租户配置分页
	 * @return
	 */
    @GetMapping("selectTenantConfigByPage")
    @ApiOperation(value = "分页查询接口", notes = "分页查询租户配置信息")
    @ApiImplicitParams({
    	    ...
    	    @ApiImplicitParam(paramType = "query", name = "styleJson", value = "租户主题样式", dataType = "String"),
    ...
    public ResponseEntity<Result<?>> selectTenantConfigByPage(Page<TenantConfig> page, TenantConfigVO bean) {
        try {
            ...
            log.error("分页查询租户配置错误！{}", e.getMessage(), e);
        }
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(Result.msg("分页查询租户配置错误！"));
    }
    
    /**
     * @Description: 主键查询租户配置
     * @return
     */
    @GetMapping("selectTenantConfigById")
    @ApiOperation(value = "主键查询接口", notes = "主键查询租户配置")
    @ApiImplicitParams({
    ...
    public ResponseEntity<Result<?>> selectTenantConfigById(TenantConfig bean) {
        try {
            ...
            log.error("主键查询租户配置错误！{}", e.getMessage(), e);
        }
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(Result.msg("主键查询租户配置错误！"));
    }
    ...
    @ApiOperation(value = "添加接口", notes = "添加租户配置接口")
    @ApiImplicitParams({
    ...
    @TraceLog(content = "添加租户配置", paramIndexs = {0})
    ...
    @ApiOperation(value = "修改接口", notes = "修改租户配置资料")
    @ApiImplicitParams({
    	@ApiImplicitParam(paramType = "query", name = "id", value = "主键", dataType = "int", required = true),
    	@ApiImplicitParam(paramType = "query", name = "tenantId", value = "租户主键ID", dataType = "Integer"),
	    @ApiImplicitParam(paramType = "query", name = "loginName", value = "登录名称", dataType = "String"),
    ...
    @TraceLog(content = "修改租户配置", paramIndexs = {0})
    ...
    @ApiOperation(value = "删除接口", notes = "删除租户配置")
    @ApiImplicitParams({
    ...
    @TraceLog(content = "删除租户配置系统用户", paramIndexs = {0})
